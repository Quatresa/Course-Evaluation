		...
		$.post(url2,data,function(result){
	        if(result.state==0){
	        	...
	        	for(var i=0;i<courseList.length;i++){
	                ...
	                var tr='<tr><td id="courseNo"><center>' +
	                courseNo +
	                '</center></td><td><center>' +
	                courseName +
	                '</center></td><td><center>' +
	                ...
	                '</center></td><td><center>' +
	                courseScore+
	                '</td><td><input type="button" value="修改" onclick="modifyCourseInfo(\''+courseNo+'\')"/></td>'+
	                '</tr>';
	              tb.append(tr);
	        	}
...
function modifyCourseInfo(courseNo){
	console.log(courseNo);
	location.href='admin_change_course.html?courseNo='+courseNo;
}
